...
namespace FreeCourse.Services.Catalog.Services
{
    public class CourseService : ICourseService
    {
        ...
        public async Task<Shared.Dtos.Response<NoContent>> UpdateAsync(CourseUpdateDto courseUpdateDto)
        {
            ...
            await _publishEndpoint.Publish<BasketCourseNameChangedEvent>(new BasketCourseNameChangedEvent {UserId = courseUpdateDto.UserId, CourseId=courseUpdateDto.Id, UpdatedName=courseUpdateDto.Name });
